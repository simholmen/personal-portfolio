...
var PROJECTS = [
  {
    ...
    description: ['Dette var prosjektet jeg jobbet med som den del av sommerjobben hos Geodata i 2026. Hovedleveransen i prosjektet var et React statusdashboard for Norsk Luftambulanse Teknologi som overvåker kartlag og datakilder i deres operative kartløsninger. Løsningen sjekker automatisk at datakildene er tilgjengelige og oppdaterte, og blir varslet når noe feiler.Dette ble gjort ved å lage flere ulike typer sjekker for å sjekke datakilden, for eksempel ved å sjekke kartlaget for hjertestartere om det finnes hjertestartere rundt Ullevål stadion. Løsningen omfatter også jevnlige synkroniseringsjobber fra eksterne kilder. '
    ],
    media: {
      type: 'gallery', pages: [
